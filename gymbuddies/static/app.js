...
import { MOCK_CALENDARS } from "./mock-data.js"
(function (Calendar) {
    var cal;
    var userEvents = [];
    // Constants
    ...
    //return UserEvents on Update Button
    function returnUserEvents() {
        return userEvents;
    }
    ...
    function bindInstanceEvents() {
      cal.on({
        ...
        beforeCreateEvent: function (event) {
          ...
          console.log("EVENT", cal.getEvent(event.id, event.calendarId));
          userEvents.push(cal.getEvent(event.id, event.calendarId));
        },
        ...
        // trying something
        sendEvents: function (){
            let userEvents = returnUserEvents()
            $.ajax({
                type:'POST',
                url:'/profile',
                javascript_data: userEvents,
    ...
    //         category: 'time',
    //         dueDateClass: '',
    //         start: '2022-11-16T22:30:00+09:00',
    //         end: '2022-11-16T02:30:00+09:00',
    //     },
    //     {
    //         id: '2',
    //         calendarId: cal.id,
    ...
    //         category: 'time',
    //         dueDateClass: '',
    //         start: '2022-11-15T17:30:00+09:00',
    //         end: '2022-11-15T17:31:00+09:00',
    //     },
    //     ]);
    //     console.log("TRIGGERED");
    //     console.log('events', cal.getEvent("1", cal.id));
